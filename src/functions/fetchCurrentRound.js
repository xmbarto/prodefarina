...
const CURRENT_ROUND = true


export const fetchCurrentRound = async () => {
    try{
        const response = await fetch(`https://v3.football.api-sports.io/fixtures/rounds?league=${A_LEAGUE_ID}&season=${CURRENT_SEASON}&current=${CURRENT_ROUND}&timezone=${TIMEZONE}`,{
            method: 'GET',
            headers:{
